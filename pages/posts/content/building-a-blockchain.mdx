...
<Note>
**Mode**
- <u>Mission</u>: Onchain finance for the next billion
...
- [Chainstack](https://chainstack.com/?ref=hemanth)
...
- [API3](https://api3.org/?ref=hemanth)
...
- `CPRSGD`
- <u>Push vs. pull</u>: Oracles can be either push (eg. RedStone, Chainlink) or pull based (eg. Pyth), and they have different tradeoffs. Typically, push-based oracles are used in situations where prices don't need to be updated as frequently (eg. lending protocols), while pull-based oracles are used when prices need to be pushed on chain as often as possible (eg. perpetuatals). Depending on the types of applications you're looking to onboard onto your network (and if they have any predispositions to a specific oracle provider), you can usually narrow down the options significantly.
...
- [Otterscan](https://otterscan.io/?ref=hemanth)
...
- Matt @ [RedStone](https://redstone.finance/?ref=hemanth)
- Jaack @ [Routescan](https://routescan.io/?ref=hemanth)
